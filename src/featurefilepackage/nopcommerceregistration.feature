...
Examples:
  ...
  |Rohan      |bakshi    |bkshi@gmail.com |45689    |""               |minimum 6 character password is required   |
...
Scenario: I should be able to select any one radio button from Gender Label of Your Personal Details section
  ...
  Then   I am able to selct any on of the radio button

Scenario Outline: I should be able to select Day Month and year from drop down list of Date of birth field
  Given  I am on Date of Birth field of your personal datial section
...
Scenario: I should be able to register with valid mandatory (*) field data on registrationa page
