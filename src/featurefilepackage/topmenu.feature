...
Scenario: Verify that user can se the Books category page with filters and list of products
When  User is on given URL
...
Then  'Sort by' filter is availableon Book category page

Scenario: Verify that user can see 'Display' filter on Book category page
Given User is on Books category page
When  User is on Books category page
And   Check 'Display' filter is present
Then  'Display' filter is availableon Book category page
...
Then  'Name: A to Z' is first option in present
